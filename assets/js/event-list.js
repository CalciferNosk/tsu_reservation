$(document).ready(function () {
	...
	$(document).on("click", ".event-edit", function (e) {
		...
		$("#edir-event-details").summernote("code", data.Details);
	...
	$(document).on("change", "#new-event-start", function () {
		var start_date = $(this).val();
		var end_date = $("#new-event-end");
		if (end_date.val() == "") {
	...
	$(document).on("submit", "#newEventForm", function (event) {
		...
		var details = $("#new-event-details").summernote('code');
		...
		if (details.trim() === '')  {
			toastifyError("Details is required");
			$("#new-event-details").focus();
			return false;
		}
		if (description == "") {
